...
class Solution:
    def quickSort(self, pairs: List[Pair]) -> List[Pair]:
        ...
        self.quick_sort_implementation(pairs, s, e)
        return pairs

    def quick_sort_implementation(self, pairs: List[Pait], s : int, e : int) -> None:
        ...
        self.quick_sort_implementation(pairs, s, left-1)
        self.quick_sort_implementation(pairs, left+1, e)
