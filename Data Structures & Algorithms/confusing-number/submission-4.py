class Solution:
    def confusingNumber(self, n: int) -> bool:
        ...
        4. If the keys not present in hashmap, return False -> do this in the while loop itself, to avoid running another for loop.
        5. If the resultant new num after the reverse and mapping is same s origibal, return Fakse, Else return True -> in the same return statement.
        """
        original_num = n
        ...
        while n != 0: # stops when n = 0.
            ...
            # whene creating reverse number, make sure to perform mapping in the same line
            # to avoid another for loop after while.
